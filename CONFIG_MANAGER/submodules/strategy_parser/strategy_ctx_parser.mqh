...
private:
    ...
    CEmasBearSellConfig *ParseEmasSellBearConfig(CJAVal *strategy_json);
...
CStrategyConfig *CStrategyConfigParser::ParseSingleStrategy(CJAVal *strategy_json)
{
    ...
    if (strategy_type == "emas_sell_bear")
    {
        Print("~~~~~~~~ ~~~~~~ ~ emas_sell_bear passou no if");
...
//+------------------------------------------------------------------+
CEmasBearSellConfig *CStrategyConfigParser::ParseEmasSellBearConfig(CJAVal *strategy_json)
{
    ...
    Print("EMA Sell Bear config parseada: ", config.name);
    return config;
}
//+------------------------------------------------------------------+
