...
CTrendLine::CTrendLine()
{
  ...
  m_lta_active=false; m_ltb_active=false; m_lta2_active=false; m_ltb2_active=false;
  m_lta_t1=0; m_lta_t2=0; m_lta_p1=0.0; m_lta_p2=0.0; m_lta2_p2=0.0; m_lta_last_break=0;
  m_ltb_t1=0; m_ltb_t2=0; m_ltb_p1=0.0; m_ltb_p2=0.0; m_ltb2_p2=0.0; m_ltb_last_break=0;
}
  ...
  if(FindNewPivotsLTB(idx_new,idx_old,p_new,p_old))
    {
      ...
      double open_new=iOpen(m_symbol,m_timeframe,id_new);
      double close_new=iClose(m_symbol,m_timeframe,id_new);
      double base_new=(MathAbs(open_new-p_new)<MathAbs(close_new-p_new)?open_new:close_new);
      double slope=CalcSlope(id_old,base_old,id_new,p_new);
      double slope2=CalcSlope(id_old,base_old,id_new,base_new);
      double angle=MathArctan2(p_new-base_old,id_new-id_old)*180.0/M_PI;
      double angle2=MathArctan2(base_new-base_old,id_new-id_old)*180.0/M_PI;
