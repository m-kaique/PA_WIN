...
- **`trend_lines.mqh`**: Implementa `CTrendLines`, responsável por detectar linhas de tendência de alta (LTA) e baixa (LTB) usando pivôs configuráveis (`left` e `right`, padrão 3 e período inicial 21).
